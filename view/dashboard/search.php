                                                  ...
                                                  <table id="dom-jqry" class="table table-striped table-bordered nowrap">
                                                      ...
                                                      <tbody>
                                                        <?php foreach($jobs as $job): ?>
                                                            <tr>
                                                                <td><a href="<?php base_url('dashboard/view_job/file/'.simple_encrypt($job['v_job_no'])) ?>"><?php print $job['v_job_no'] ?></a></td>
                                                                <td><?php print $job['v_eta'] ?></td>
                                                                <td><?php print $job['v_mawb'] ?></td>
                                                                <td><?php print $job['v_qty'] ?></td>
                                                                <td><?php print $job['v_gw'] ?></td>
                                                                <td><?php print $job['v_cw'] ?></td>
                                                                <td><?php print $job['v_al'] ?></td>
                                                                <td><?php print $job['v_orig'] ?></td>
                                                                <td><?php print $job['v_remarks'] ?></td>
                                                            </tr>
                                                        <?php endforeach ?>
                                                  </tbody>
                                                  </table>
