                          ...
                          <!-- Flying Word card start -->
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <form action="<?php base_url('dashboard/new_client/') ?>" method="POST">
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">Client Short Name</small>
                                            <input type="text" name="client_short_name" class="form-control" value="<?php print $short_name ?>" placeholder="Client Short Name" required />
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">Client Full Name</small>
                                            <input type="text" name="client_full_name" class="form-control" value="<?php print $client_full_name ?>" placeholder="Client Full Name" required />
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">Address</small>
                                            <input type="text" name="address" class="form-control" value="<?php print $address ?>" placeholder="Address" required />
                                        </div>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="text" name="con_full_name" class="form-control" value="<?php print $con_full_name ?>" placeholder="Contact Full Name" required />
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">E-mail</small>
                                            <input type="email" name="con_email" class="form-control" value="<?php print $con_email ?>" placeholder="Contact E-mail" required />
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">Telephone</small>
                                            <input type="text" name="con_tel" class="form-control" value="<?php print $con_tel ?>" placeholder="Contact Phone No" required />
                                        </div>
