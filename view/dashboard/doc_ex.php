                              ...
                              <div class="card-block rounded shadow-lg info-breadcrumb">
                                  ...
                                  <div class="page-header-breadcrumb">
                                      <ul class="breadcrumb-title">
                                          ...
                                          <li class="breadcrumb-item"><a href="">New Document Exchange</a>
                                          </li>
                                      </ul>
                                  </div>
                              </div>
                          ...
                          <!-- Flying Word card start -->
                            <div class="card">
                                <div class="card-block">
                                    ...
                                    <form action="<?php base_url('dashboard/doc_ex/') ?>" method="POST">
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">Job No</small>
                                            <input type="text" name="job_no" class="form-control" value="<?php print $job_no ?>" placeholder="Job No" required />
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">B/L</small>
                                            <input type="text" name="b_l" class="form-control" value="<?php print $b_l ?>" placeholder="B/L" required />
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">INVOICE NO</small>
                                            <input type="text" name="invoice_no" class="form-control" value="<?php print $invoice_no ?>" placeholder="INVOICE NO" required />
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">PAYMENT MODE</small>
                                            <input type="text" name="payment_mode" class="form-control" value="<?php print $payment_mode ?>" placeholder="PAYMENT MODE" required />
                                        </div>
                                        <div class="col-sm-12 mt-2 d-flex justify-content-end">
                                            <button type="submit" name="doc_ex_btn" class="btn btn-info m-r-10 rounded shadow-lg"> <i class="icofont icofont-plus"></i> Create</button>
                                        </div>
                                    </div>
                                    </form>
                                </div>
