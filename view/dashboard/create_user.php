              ...
              <div class="card borderless-card">
                      <div class="card-block rounded shadow-lg info-breadcrumb">
                          <div class="breadcrumb-header">
                              ...
                              <span>Details will be emailed to user.</span>
                          </div>
                      ...
                      <!-- Left column start -->
                        <div class="col-lg-6 col-xl-6">
                                ...
                                <div class="card-block">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <input type="text" name="new_full_name" class="form-control" placeholder="Enter full name" required />
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">Email Address</small>
                                            <input type="text" name="new_mail" class="form-control" placeholder="Enter value" required />
                                        </div>
                                        <div class="col-sm-12 mb-3">
                                            <small class="col-lable">Password</small>
                                            <input type="password" name="new_psw" class="form-control" placeholder="Enter value" required />
                                        </div>
                                    </div>
                                    </form>
                                </div>
                          ...
                          <div class="col-lg-6 col-xl-6">
                              ...
                              <div class="card">
                                  <div class="card-block">
                                      <h4 class="sub-title">User Details Cont..</h4>
                                        <div class="form-group">
                                            <small class="col-lable">I.P Address</small>
                                            <input type="text" form="newuser" class="form-control" name="ip_address" placeholder="I.P Address - Add multiple e.g (192.168.0.1, 127.0.0.1, 178.3.32.1)" required />
                                        </div>
                                        <div class="form-group row">
                                              <div class="col-sm-12 mb-3">
                                            <small class="col-lable">Role</small>
                                            <select form="newuser" name="new_role" class="form-control" required>
                                            ...
                                            <button type="submit" form="newuser" name="new_user" class="btn btn-info m-r-10 rounded shadow-lg mt-4"> <i class="icofont icofont-plus"></i> Create User</button>
                                        </div>
                                  </div>
                              </div>
                          </div>
