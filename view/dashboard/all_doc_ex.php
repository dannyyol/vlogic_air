                          ...
                          <?php Response() ?>
                            <div class="card table-card">
                                <div class="card-header">
                                    <h5>All Document Exchange</h5>
                                </div>
                                <div class="card-block pl-3 pr-3">
                                    <?php if(empty($doc_exs)): ?>
                                            ...
                                            <div class="card-block">
                                                <div class="table-responsive dt-responsive" id='data'>
                                                  <table class="table table-striped table-bordered nowrap">
                                                      ...
                                                      <tbody>
                                                        <?php foreach($doc_exs as $doc_ex): ?>
                                                            <tr>
                                                                <td><?php print $doc_ex['de_job_no'] ?></td>
                                                                <td><?php print $doc_ex['de_b_l'] ?></td>
                                                                <td><?php print $doc_ex['de_invoice_no'] ?></td>
                                                                <td><?php print $doc_ex['de_payment_mode'] ?></td>
                                                                <td><?php print formatDate($doc_ex['de_date_added'],'full abb') ?></td>
                                                                <td><a href="<?php base_url('dashboard/view_doc_ex/doc_ex/'.$doc_ex['doc_ex_id']) ?>">View Document</a></td>
                                                            </tr>
                                                        <?php endforeach ?>
                                                    </tbody>
                                                  </table>
                                    ...
                                    <ul class="pagination">
                                      <?php paginationFooter('dashboard/all_doc_ex/page/', 'active', TRUE) ?>
                                    </ul>
                                    <?php endif ?>
