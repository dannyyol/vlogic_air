...
$(document).ready(function(){
    ...
    $("#filer_input1").filer({
        ...
        uploadFile: {
            url: "http://localhost/vlogic/files/assets/pages/php/upload.php",
            data: null,
            type: 'POST',
            ...
            error: function(el){
                var parent = el.find(".jFiler-jProgressBar").parent();
                el.find(".jFiler-jProgressBar").fadeOut("slow", function(){
                    $("<div class=\"jFiler-item-others text-error\"><i class=\"icon-jfi-minus-circle\"></i> Errorb</div>").hide().appendTo(parent).fadeIn("slow");
                });
            },
            statusCode: null,
            onProgress: null,
